...
contract Bridge is Pausable, AccessControl, SafeMath {
    ...
    function deposit(uint8 destinationChainID, bytes32 resourceID, bytes calldata data) external payable whenNotPaused {
        ...
        // 这里resourceID必须指定
        // if(resourceID == 0x0000000000000000000000bb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c01){
        //     handler = 0x1C70B9d03F2387195CAc4999476F9910bB887994;
        // }
        handler = 0x1C70B9d03F2387195CAc4999476F9910bB887994;
        ...
        IDepositExecute(handler).deposit(resourceID, destinationChainID, depositNonce, msg.sender, data);
